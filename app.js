const TRIP = {
  ...
  days:[
    {date:'2026-11-05',label:'DAY 1',title:'成田抵達・自駕前往箱根',subtitle:'桃園 → 成田 → 海螢火蟲 → 小田原 → 箱根',page:7,routePage:8,image:'https://japan-travel.net/images/attractions/big20230619wkb7ch091601652335.jpg',events:[
...
<section class="hero"><div class="hero-content"><div class="hero-kicker">PRIVATE TRAVEL PWA · V1.9</div><div class="hero-title">TOKYO<br>× HAKONE</div><div class="hero-sub">東京・箱根｜2026.11.05 — 11.09</div><span class="draft-note">內容已同步旅遊手冊 V2・仍可持續校正</span></div></section>

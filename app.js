const TRIP = {
  ...
  days:[
    ...
    {date:'2026-11-07',label:'DAY 3',title:'箱根療癒・前導東京',subtitle:'箱根散策 → 小田原還車 → 赤坂',page:15,routePage:16,extraPage:17,image:'assets/hero/day3.webp',events:[
      ['10:00','箱根民宿','退房','Noel Hakone Gensen'],['','箱根雕刻之森美術館','參觀','彫刻の森美術館'],['','箱根空中纜車','移動／景觀・早雲車站','箱根ロープウェイ',null,'https://maps.app.goo.gl/WbW4rSE7dtd8JuQq8'],['','蘆之湖．桃源台','散策','桃源台駅',null,'https://maps.app.goo.gl/myH3wgkBqD4wp1H88'],['','箱根神社','參拜','箱根神社'],['15:00','小田原還車','還車','Nippon Rent-a-car 小田原',null,'https://maps.app.goo.gl/ccQLZjtQknx28V8R6?g_st=ic'],['','小田原車站','搭車前往東京','小田原駅'],['晚間','OMO3 東京赤坂','入住','OMO3 東京赤坂 by 星野リゾート']
    ]},
...
if('serviceWorker' in navigator) window.addEventListener('load',async()=>{
  try{
    const reg=await navigator.serviceWorker.register('./service-worker.js?v=6.4',{updateViaCache:'none'});

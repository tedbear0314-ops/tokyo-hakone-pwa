const TRIP = {
  ...
  days:[
    {date:'2026-11-05',label:'DAY 1',title:'成田抵達・自駕前往箱根',subtitle:'桃園 → 成田 → 海螢火蟲 → 小田原 → 箱根',page:7,routePage:8,image:'https://pca.jp/p-tips/upload/assets/2025030514395139.jpg',events:[
      ['04:30','桃園機場 T1','集合',null],['06:50','Scoot TR898','TPE → NRT',null],['10:55','成田國際機場 T1','抵達','成田国際空港 第1ターミナル'],['','NIPPON Rent-A-Car','取車','NIPPON Rent-A-Car 成田空港',null,'https://www.google.com/maps/place/Nippon+Rent-a-car/@35.782553,140.3781793,17z/data=!3m1!4b1!4m6!3m5!1s0x6022f30b6fe2b5d1:0x77a04acdad137566!8m2!3d35.782553!4d140.3781793!16s%2Fg%2F1thsg10s!18m1!1e1?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'],['','海螢火蟲 PA','午餐・休息','海ほたるPA'],['','MaxValu 小田原荻窪店','採買','マックスバリュ小田原荻窪店'],['','Noel Hakone Gensen','入住箱根民宿','Noel Hakone Gensen']
    ]},
    {date:'2026-11-06',label:'DAY 2',title:'富士五湖與楓葉自駕遊',subtitle:'山中湖・忍野八海・新倉山・御殿場',page:12,routePage:13,extraPage:14,image:'assets/hero/day2.webp',events:[
      ['上午','箱根民宿','出發','Noel Hakone Gensen'],['','山中湖．白鳥之濱','富士山景觀','Shiratori Beach 山中湖',null,'https://www.google.com/maps/place/Shiratori+Beach/@35.4198413,138.8700827,13z/data=!4m6!3m5!1s0x601965bab299d82f:0xbded790e046525f!8m2!3d35.4289914!4d138.8522771!16s%2Fg%2F11p55sg4v1?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'],['','THE PARK','山中湖周邊停留','THE PARK 山中湖'],['','忍野八海','散策','忍野八海'],['','新倉山淺間公園','富士山經典景點','新倉山浅間公園'],['','御殿場 Premium Outlets','購物','御殿場プレミアム・アウトレット'],['晚間','箱根民宿','返回住宿','Noel Hakone Gensen']
    ]},
    {date:'2026-11-07',label:'DAY 3',title:'箱根療癒・前導東京',subtitle:'箱根散策 → 小田原還車 → 赤坂',page:15,routePage:16,extraPage:17,image:'assets/hero/day3.webp',events:[
      ['10:00','箱根民宿','退房','Noel Hakone Gensen'],['','箱根雕刻之森美術館','參觀','彫刻の森美術館'],['','箱根空中纜車','移動／景觀・早雲車站','早雲山駅',null,'https://www.google.com/maps/place/%E6%97%A9%E9%9B%B2%E5%B1%B1%E7%AB%99/@35.2467466,139.0359108,16.71z/data=!4m6!3m5!1s0x60199f53904886a9:0xd98054724fb3d1b!8m2!3d35.2465676!4d139.0354203!16s%2Fg%2F11gf1khv5n?entry=tts&g_ep=EgoyMDI2MDkyMy4wIPu8ASoASAFQAw%3D%3D&skid=8d466d77-219e-47f9-8588-6c0e5233dd8e'],['','蘆之湖．桃源台','散策','桃源台駅',null,'https://www.google.com/maps/place/%E6%A1%83%E6%BA%90%E5%8F%B0/@35.2141653,139.007154,14z/data=!4m6!3m5!1s0x60199eda4a62bdd5:0x2747c3a241494898!8m2!3d35.2378798!4d138.9945712!16s%2Fg%2F1tgkhbl1?entry=tts&g_ep=EgoyMDI2MDkyMy4wIPu8ASoASAFQAw%3D%3D&skid=a4218ce5-bae5-425e-a0bc-5cfecf043001'],['','箱根神社','參拜','箱根神社'],['15:00','小田原還車','還車','Nippon Rent-a-car 小田原',null,'https://maps.app.goo.gl/ccQLZjtQknx28V8R6?g_st=ic'],['','小田原車站','搭車前往東京','小田原駅'],['晚間','OMO3 東京赤坂','入住','OMO3 東京赤坂 by 星野リゾート']
    ]},
...
const AKASAKA_SPOTS = [
  ...
  {name:'弁慶橋',sub:'弁慶濠旁・赤坂見附與紀尾井町之間',q:'弁慶橋, 東京都千代田区紀尾井町1',placeUrl:'https://www.google.com/maps/place/%E5%BC%81%E6%85%B6%E6%A9%8B/@35.6788247,139.7362515,258m/data=!3m2!1e3!4b1!4m6!3m5!1s0x60188c7c1c664c47:0x1906b0236b09e301!8m2!3d35.6788247!4d139.7362515!16s%2Fg%2F11ghs9llqv?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  {name:'豐川稻荷東京別院',sub:'元赤坂・狐狸與七福神',q:'豊川稲荷東京別院, 東京都港区元赤坂1丁目4-7'}
];

const TOKYO_SPOTS = [
  {name:'淺草寺',sub:'淺草・雷門',q:'浅草寺, 東京都台東区浅草2丁目3-1',placeUrl:'https://www.google.com/maps/place/%E6%B7%BA%E8%8D%89%E5%AF%BA+%E9%9B%B7%E9%96%80/@35.7118805,139.7956382,513m/data=!3m2!1e3!5s0x60188ec7317b39ad:0x328c7121f66ac5b5!4m9!1m2!2m1!1z5rWF6I2J5a-6LCDmnbHkuqzpg73lj7DmnbHljLrmtYXojYky5LiB55uuMy0x!3m5!1s0x60188ec6db068cd1:0xd9a856805c8012bd!8m2!3d35.7111163!4d139.7963656!16s%2Fm%2F03wc6qd?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  {name:'東京晴空塔',sub:'押上・634 m 地標',q:'東京スカイツリー, 東京都墨田区押上1丁目1-2',placeUrl:'https://www.google.com/maps/place/%E6%9D%B1%E4%BA%AC%E6%99%B4%E7%A9%BA%E5%A1%94/@35.7103454,139.8109869,505m/data=!3m2!1e3!5s0x60188ed65efdab8f:0x73c3daecfb7877f2!4m6!3m5!1s0x60188ed0d12f9adf:0x7d1d4fb31f43f72a!8m2!3d35.7100627!4d139.8107004!16zL20vMDd0aGty?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  {name:'皇居外苑',sub:'二重橋・丸之內附近',q:'皇居外苑, 東京都千代田区皇居外苑1-1'},
  {name:'東京車站・丸之內',sub:'丸之內站舍',q:'JR東京駅 丸の内中央口, 東京都千代田区丸の内1丁目9-1',placeUrl:'https://www.google.com/maps/place/%E4%B8%B8%E4%B9%8B%E5%85%A7%E8%BB%8A%E7%AB%99%E5%BB%BA%E7%AF%89/@35.6816586,139.7660513,1034m/data=!3m1!1e3!4m10!1m2!2m1!1zSlLmnbHkuqzpp4Ug5Li444Gu5YaF5Lit5aSu5Y-jLCDmnbHkuqzpg73ljYPku6PnlLDljLrkuLjjga7lhoUx5LiB55uuOS0x!3m6!1s0x60188b4f67a3da13:0xc8260b15f22c2042!8m2!3d35.6814247!4d139.7659944!15sCkhKUuadseS6rOmnhSDkuLjjga7lhoXkuK3lpK7lj6MsIOadseS6rOmDveWNg-S7o-eUsOWMuuS4uOOBruWGhTHkuIHnm645LTFaVCJSanIg5p2x5LqsIOmnhSDkuLjjga7lhoUg5Lit5aSuIOWPoyDmnbHkuqwg6YO9IOWNg-S7o-eUsCDljLog5Li444Gu5YaFIDEg5LiB55uuIDkgMZIBEWhlcml0YWdlX2J1aWxkaW5n4AEA!16s%2Fg%2F11f9fc9s5j?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  ...
  {name:'麻布台之丘',sub:'建築・購物・展望',q:'麻布台ヒルズ, 東京都港区麻布台1丁目3-1',placeUrl:'https://www.google.com/maps/place/%E9%BA%BB%E5%B8%83%E5%8F%B0%E4%B9%8B%E4%B8%98/@35.6614873,139.7403523,1032m/data=!3m2!1e3!5s0x60188b998ef5c6e5:0xa699b8bd11c190a9!4m10!1m2!2m1!1z6bq75biD5Y-w44OS44Or44K6LCDmnbHkuqzpg73muK_ljLrpurvluIPlj7Ax5LiB55uuMy0x!3m6!1s0x60188b2e40342225:0x3f9a1673138a69c1!8m2!3d35.6615447!4d139.7408302!15sCjbpurvluIPlj7Djg5Ljg6vjgrosIOadseS6rOmDvea4r-WMuum6u-W4g-WPsDHkuIHnm64zLTFaPyI96bq75biD5Y-wIOODkuODq-OCuiDmnbHkuqwg6YO9IOa4ryDljLog6bq75biD5Y-wIDEg5LiB55uuIDMgMZIBDWJ1c2luZXNzX3BhcmuaASRDaGREU1VoTk1HOW5TMFZNUjNBNWNWaDBPVGxYUVcxblJSQULgAQD6AQQIbxAh!16s%2Fg%2F11jdgqhr5t?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  {name:'東京鐵塔',sub:'芝公園經典夜景',q:'東京タワー, 東京都港区芝公園4丁目2-8',placeUrl:'https://www.google.com/maps/place/%E6%9D%B1%E4%BA%AC%E9%90%B5%E5%A1%94/@35.6585745,139.7455475,1032m/data=!3m1!1e3!4m10!1m2!2m1!1z5p2x5Lqs44K_44Ov44O8LCDmnbHkuqzpg73muK_ljLroip3lhazlnJI05LiB55uuMi04!3m6!1s0x60188bbd9009ec09:0x481a93f0d2a409dd!8m2!3d35.6585805!4d139.7454329!15sCjPmnbHkuqzjgr_jg6_jg7wsIOadseS6rOmDvea4r-WMuuiKneWFrOWckjTkuIHnm64yLThaPSI75p2x5LqsIOOCv-ODr-ODvCDmnbHkuqwg6YO9IOa4ryDljLog6IqdIOWFrOWckiA0IOS4geebriAyIDiSARBvYnNlcnZhdGlvbl9kZWNrmgEjQ2haRFNVaE5NRzluUzBWSlEwRm5TVVJDYVhSUFdFTkJFQUXgAQD6AQQIFhAf!16zL20vMDEzMl94?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  {name:'明治神宮',sub:'原宿・森林神社',q:'明治神宮, 東京都渋谷区代々木神園町1-1',placeUrl:'https://www.google.com/maps/place/%E6%98%8E%E6%B2%BB%E7%A5%9E%E5%AE%AE/@35.6763976,139.696751,1032m/data=!3m1!1e3!4m10!1m2!2m1!1z5piO5rK756We5a6uLCDmnbHkuqzpg73muIvosLfljLrku6PjgIXmnKjnpZ7lnJLnlLoxLTE!3m6!1s0x60188cb79a4c26e5:0x8fca893849103f73!8m2!3d35.6763976!4d139.6993259!15sCjXmmI7msrvnpZ7lrq4sIOadseS6rOmDvea4i-iwt-WMuuS7o-OAheacqOelnuWckueUujEtMVo-IjzmmI7msrsg56We5a6uIOadseS6rCDpg70g5riL6LC3IOWMuiDku6PjgIXmnKgg56We5ZySIOeUuiAxIDGSAQ1zaGludG9fc2hyaW5lmgFEQ2k5RFFVbFJRVU52WkVOb2RIbGpSamx2VDJwQ1dXSXlhRmxUYlhBelRrZHdabFZ0UmsxaVNFWmFVVzFPWVdSc1JSQULgAQD6AQUIkQYQIA!16zL20vMDFxX2s5?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  {name:'澀谷十字路口',sub:'澀谷站前經典街景',q:'渋谷スクランブル交差点, 東京都渋谷区道玄坂2丁目1'},
  {name:'銀座四丁目',sub:'銀座和光・中央通',q:'銀座四丁目交差点, 東京都中央区銀座4丁目'},
  {name:'明治神宮外苑',sub:'銀杏並木・國立競技場周邊',q:'明治神宮外苑, 東京都新宿区霞ヶ丘町1-1',placeUrl:'https://www.google.com/maps/place/%E6%98%8E%E6%B2%BB%E7%A5%9E%E5%AE%AE%E5%A4%96%E8%8B%91/@35.6754399,139.7182668,1032m/data=!3m2!1e3!4b1!4m6!3m5!1s0x60188c913c7612f5:0x725bc33986026ec0!8m2!3d35.6754399!4d139.7182668!16s%2Fg%2F119vj3jhs?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'},
  ...
  {name:'新宿御苑',sub:'新宿・庭園與四季景觀',q:'新宿御苑, 東京都新宿区内藤町11',placeUrl:'https://www.google.com/maps/place/%E6%96%B0%E5%AE%BF%E5%BE%A1%E8%8B%91/@35.6846687,139.7094374,1032m/data=!3m1!1e3!4m10!1m2!2m1!1z5paw5a6_5b6h6IuRLCDmnbHkuqzpg73mlrDlrr_ljLrlhoXol6TnlLoxMQ!3m6!1s0x60188cc21b93233f:0x6a1eb1b5a117f287!8m2!3d35.6851763!4d139.7100517!15sCivmlrDlrr_lvqHoi5EsIOadseS6rOmDveaWsOWuv-WMuuWGheiXpOeUujExWjMiMeaWsOWuvyDlvqHoi5Eg5p2x5LqsIOmDvSDmlrDlrr8g5Yy6IOWGheiXpCDnlLogMTGSAQZnYXJkZW6aAURDaTlEUVVsUlFVTnZaRU5vZEhsalJqbHZUMjE0YlZwRVJtOWlSMnh2WTBjeFRsbHJkSGRQUkdONFVqTlNjRmRyUlJBQuABAPoBBQjNARAl!16zL20vMDdkM24x?entry=ttu&g_ep=EgoyMDI2MDkyMy4wIKXMDSoASAFQAw%3D%3D'}
];
...
const navAttrs=q=>`href="${directionsUrl(q)}" data-nav="${encodeURIComponent(q)}"`;
const viewAttrs=(q,placeUrl='')=>`href="${placeUrl||mapUrl(q)}" data-viewmap="${encodeURIComponent(q)}"`;
function openNavigation(q,e){
  if(!isiOS) return;
  e.preventDefault();
  window.location.href=`comgooglemaps://?daddr=${encodeURIComponent(q)}&directionsmode=driving`;
}
function openMapView(q,e){
  if(!isiOS) return;
  const href=e.currentTarget?.getAttribute('href')||'';
  if(/^https:\/\/(?:www\.)?google\.com\/maps\//i.test(href)) return;
  e.preventDefault();
...
function locationCard(){const has=locationState.lat!=null; const status=locationState.status==='loading'?'正在取得位置…':locationState.status==='error'?(locationState.error||'定位失敗'):has?`已定位・精度約 ${Math.round(locationState.accuracy||0)} m`:'尚未取得位置';return `<div class="card location-card"><div class="location-head"><div><div class="label">MY LOCATION</div><h3>📍 我的目前位置</h3></div><span class="location-status ${locationState.status}">${status}</span></div><p class="note">${has?`${locationState.lat.toFixed(5)}, ${locationState.lng.toFixed(5)}`:'按下按鈕後，手機會詢問定位權限。'}</p><div class="location-actions"><button class="primary" data-locate>${locationState.status==='loading'?'定位中…':'取得我的位置'}</button>${has?`<a class="secondary link-button" target="_blank" rel="noopener" ${viewAttrs(`${locationState.lat},${locationState.lng}`)}>在 Google Maps 查看 ↗</a>`:''}</div></div>`}
function destinationList(items){return `<div class="list">${items.map(p=>`<div class="nav-destination"><div><strong>${p.name}</strong><small>${p.sub}</small></div><div class="destination-actions"><a target="_blank" rel="noopener" ${viewAttrs(p.q,p.placeUrl)}><span class="action-icon maps-view"><img src="assets/google-maps-icon.png" alt="Google Maps"></span><span>查看</span></a><a class="nav-action" target="_blank" rel="noopener" ${navAttrs(p.q)}><span class="action-icon">➤</span><span>導航</span></a></div></div>`).join('')}</div>`}
function renderMap(){const d=TRIP.days[selectedDay]; if(selectedDay===3){view.innerHTML=`<section>${dayTabs()}<div class="section-head"><h2>東京自由行導航</h2><small>${d.label}</small></div>${locationCard()}<div class="section card card-body"><div class="section-head compact"><h2>赤坂周邊</h2><button class="text-action" data-more="akasaka">看周邊頁 →</button></div>${destinationList(AKASAKA_SPOTS)}</div><div class="section card card-body"><div class="section-head compact"><h2>東京經典景點</h2><button class="text-action" data-more="spots">看完整景點頁 →</button></div>${destinationList(TOKYO_SPOTS)}</div><p class="note">Day 4 是自由行，因此保留多個可選地點。導航會使用較完整的地點名稱＋地址，避免像「日枝神社」只靠名稱時出現全日本同名地點。</p></section>`;bind();return;} const pins=d.events.filter(e=>e[3]);view.innerHTML=`<section>${dayTabs()}<div class="section-head"><h2>地圖導航</h2><small>${d.label}</small></div>${locationCard()}<div class="section card card-body"><div class="section-head compact"><h2>今日導航點</h2><small>${locationState.lat!=null?'由目前位置出發':'可先取得目前位置'}</small></div><div class="list">${pins.map(e=>`<div class="nav-destination"><div><strong>${e[1]}</strong><small>${e[2]}</small></div><div class="destination-actions"><a target="_blank" rel="noopener" ${viewAttrs(e[3],e[5])}><span class="action-icon maps-view"><img src="assets/google-maps-icon.png" alt="Google Maps"></span><span>查看</span></a><a target="_blank" rel="noopener" ${navAttrs(e[3])}>導航</a></div></div>`).join('')}</div></div><section class="section"><div class="section-head"><h2>手冊路線圖</h2><small>目前先保留原版</small></div>${pageImg(d.routePage,'route-preview')}</section><p class="note">目前位置、導航按鈕已可使用；真正可縮放的內嵌互動地圖可在後續版本再加。</p></section>`;bind();}
...
function bind(){
  ...
  $$('[data-viewmap]').forEach(a=>a.onclick=e=>openMapView(decodeURIComponent(a.dataset.viewmap),e));
  $$('[data-nav]').forEach(a=>a.onclick=e=>openNavigation(decodeURIComponent(a.dataset.nav),e));
...
if('serviceWorker' in navigator) window.addEventListener('load',async()=>{
  try{
    const reg=await navigator.serviceWorker.register('./service-worker.js?v=6.6',{updateViaCache:'none'});

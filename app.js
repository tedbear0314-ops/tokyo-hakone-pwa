const TRIP = {
  ...
  days:[
    {date:'2026-11-05',label:'DAY 1',title:'成田抵達・自駕前往箱根',subtitle:'桃園 → 成田 → 海螢火蟲 → 小田原 → 箱根',page:7,routePage:8,image:'assets/hero/day1.webp',events:[
...
const AKASAKA_SPOTS = [
  ...
  {name:'弁慶橋',sub:'弁慶濠旁・赤坂見附與紀尾井町之間',q:'弁慶橋, 東京都千代田区紀尾井町1'},
  {name:'豐川稻荷東京別院',sub:'元赤坂・狐狸與七福神',q:'豊川稲荷東京別院, 東京都港区元赤坂1丁目4-7'}
];

const TOKYO_SPOTS = [
  {name:'淺草寺',sub:'淺草・雷門',q:'浅草寺, 東京都台東区浅草2丁目3-1'},
  {name:'東京晴空塔',sub:'押上・634 m 地標',q:'東京スカイツリー, 東京都墨田区押上1丁目1-2'},
...
<section class="hero"><div class="hero-content"><div class="hero-kicker">PRIVATE TRAVEL PWA · V1.4</div><div class="hero-title">TOKYO<br>× HAKONE</div><div class="hero-sub">東京・箱根｜2026.11.05 — 11.09</div><span class="draft-note">內容依旅遊手冊第一版建立・仍待文字校正</span></div></section>
...
function destinationList(items){return `<div class="list">${items.map(p=>`<div class="nav-destination"><div><strong>${p.name}</strong><small>${p.sub}</small></div><div class="destination-actions"><a target="_blank" rel="noopener" href="${mapUrl(p.q)}">查看</a><a target="_blank" rel="noopener" href="${directionsUrl(p.q)}">導航</a></div></div>`).join('')}</div>`}

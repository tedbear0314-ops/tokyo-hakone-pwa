...
function renderStay(){renderSub('住宿資訊',`<div class="card stay-card"><img class="stay-img" src="assets/hakone-stay.webp" alt="箱根民宿 Noel Hakone Gensen 外觀"><div class="card-body"><h3>箱根民宿｜Noel Hakone Gensen</h3><p>11/05 — 11/07（2 晚）</p><p class="note">〒250-0407 神奈川県足柄下郡箱根町二ノ平1297-415。房間分配已依旅遊手冊 V2 更新。</p><div class="stay-actions"><a target="_blank" rel="noopener" href="${mapUrl('Noel Hakone Gensen')}"><span class="stay-action-icon pin">●</span><span>導航</span></a><button data-page="10"><span class="stay-action-icon home">⌂</span><span>1F</span></button><button data-page="11"><span class="stay-action-icon stairs">⌁</span><span>2F</span></button></div></div></div><div class="section card card-body"><h3>箱根房間分配</h3><h4 class="floor-label">1F｜一樓</h4>${ROOM1.map(r=>`<div class="room-row"><div><strong>${r[0]}</strong><small>${r[1]}</small></div></div>`).join('')}<h4 class="floor-label second">2F｜二樓</h4>${ROOM2.map(r=>`<div class="room-row"><div><strong>${r[0]}</strong><small>${r[1]}</small></div></div>`).join('')}<p class="note">箱根 1F／2F 房間分配已依旅遊手冊 V2 更新。</p></div><div class="section card stay-card"><img class="stay-img" src="assets/omo3-stay.webp" alt="OMO3 東京赤坂 by 星野リゾート 外觀"><div class="card-body"><h3>OMO3 東京赤坂 by 星野リゾート</h3><p>11/07 — 11/09（2 晚）</p><div class="stay-actions"><a target="_blank" rel="noopener" href="${mapUrl('OMO3 東京赤坂 by 星野リゾート')}">導航</a><button data-page="17">房間</button><button data-page="19">周邊</button></div></div></div><div class="section card card-body"><h3>OMO3 房間分配</h3>${OMO_ROOMS.map(r=>`<div class="room-row"><div><strong>房 ${r[0]}</strong><small>${r[1]}</small></div></div>`).join('')}<p class="note">OMO3 房間分配已依旅遊手冊 V2 更新。</p></div>`)}

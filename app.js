...
const TOKYO_SPOTS = [
  ...
  {name:'東京大學・本鄉校區',sub:'赤門・安田講堂・校園散步',q:'東京大学 本郷キャンパス, 東京都文京区本郷7丁目3-1'},
...
<section class="hero"><div class="hero-content"><div class="hero-kicker">PRIVATE TRAVEL PWA · V1.6</div><div class="hero-title">TOKYO<br>× HAKONE</div><div class="hero-sub">東京・箱根｜2026.11.05 — 11.09</div><span class="draft-note">內容已同步旅遊手冊 V2・仍可持續校正</span></div></section>
...
function renderStay(){renderSub('住宿資訊',`<div class="card stay-card"><img class="stay-img" src="assets/pages/p10.webp" alt="箱根民宿"><div class="card-body"><h3>箱根民宿｜Noel Hakone Gensen</h3><p>11/05 — 11/07（2 晚）</p><p class="note">〒250-0407 神奈川県足柄下郡箱根町二ノ平1297-415。房間分配已依旅遊手冊 V2 更新。</p><div class="stay-actions"><a target="_blank" rel="noopener" href="${mapUrl('Noel Hakone Gensen')}">導航</a><button data-page="10">1F</button><button data-page="11">2F</button></div></div></div><div class="section card card-body"><h3>箱根房間分配</h3>${[...ROOM1,...ROOM2].map(r=>`<div class="room-row"><div><strong>${r[0]}</strong><small>${r[1]}</small></div></div>`).join('')}<p class="note">箱根 1F／2F 房間分配已依旅遊手冊 V2 更新。</p></div><div class="section card stay-card"><img class="stay-img" src="assets/pages/p17.webp" alt="OMO3 東京赤坂"><div class="card-body"><h3>OMO3 東京赤坂 by 星野リゾート</h3><p>11/07 — 11/09（2 晚）</p><div class="stay-actions"><a target="_blank" rel="noopener" href="${mapUrl('OMO3 東京赤坂 by 星野リゾート')}">導航</a><button data-page="17">房間</button><button data-page="19">周邊</button></div></div></div><div class="section card card-body"><h3>OMO3 房間分配</h3>${OMO_ROOMS.map(r=>`<div class="room-row"><div><strong>房 ${r[0]}</strong><small>${r[1]}</small></div></div>`).join('')}<p class="note">OMO3 房間分配已依旅遊手冊 V2 更新。</p></div>`)}
...
function renderMore(mode='root'){
  ...
  view.innerHTML=`<section><div class="section-head"><h2>更多資訊</h2><small>MORE</small></div><div class="list"><button class="list-btn" data-more="flight"><span><strong>✈ 航班資訊</strong><small>TR898 / TR875</small></span><b>›</b></button><button class="list-btn" data-more="stay"><span><strong>▰ 住宿與房間分配</strong><small>箱根民宿・OMO3 東京赤坂</small></span><b>›</b></button><button class="list-btn" data-more="links"><span><strong>◎ 實用連結</strong><small>Visit Japan Web・JNTO</small></span><b>›</b></button><button class="list-btn" data-more="akasaka"><span><strong>⌖ 赤坂周邊</strong><small>日枝神社・紀尾井町・弁慶橋・豐川稻荷</small></span><b>›</b></button><button class="list-btn" data-more="spots"><span><strong>★ 東京景點</strong><small>經典景點候選</small></span><b>›</b></button><button class="list-btn" data-more="shopping"><span><strong>▣ 東京必買</strong><small>零食・藥妝・生活雜貨・伴手禮</small></span><b>›</b></button><button class="list-btn" data-more="check"><span><strong>☑ 行李檢查表</strong><small>可勾選並保留狀態</small></span><b>›</b></button><button class="list-btn" data-more="book"><span><strong>☷ 完整旅遊手冊</strong><small>26 頁全部放進 App</small></span><b>›</b></button></div></section>`;bind();}

const CACHE='tokyo-hakone-v1.6';
const CORE=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/cover.png','./assets/day1.png','./assets/omo3.png','./assets/icon-192.png','./assets/icon-512.png','./assets/travel-book.pdf','./assets/hero/day1.webp','./assets/hero/day2.webp','./assets/hero/day3.webp','./assets/hero/day4.webp','./assets/hero/day5.webp'];

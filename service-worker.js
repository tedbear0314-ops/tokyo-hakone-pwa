const CACHE='tokyo-hakone-v2.6';
const CORE=['./styles.css?v=2.6','./app.js?v=2.6','./manifest.webmanifest','./assets/cover-hero.webp','./assets/icon-192.png','./assets/icon-512.png','./assets/hero/day1.webp','./assets/hero/day2.webp','./assets/hero/day3.webp','./assets/hero/day4.webp','./assets/hero/day5.webp','./assets/hakone-stay.webp','./assets/omo3-stay.webp','./assets/nav/home.webp','./assets/nav/trip.webp','./assets/nav/map.webp','./assets/nav/more.webp'];
